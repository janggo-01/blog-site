...
<body data-topbar="dark">
    ...
    <div id="layout-wrapper">
        ...
        @include('admin/sidebottomup/header')

        <!-- ========== Left Sidebar Start ========== -->
        @include('admin/sidebottomup/sidebar')
        <!-- Left Sidebar End -->
        ...
        <div class="main-content">
            ...
            @include('admin/sidebottomup/footer')
    ...
    <script src="/backend/assets/libs/datatables.net/js/backend//jquery.dataTables.min.js"></script>
