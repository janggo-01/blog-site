                        ...
                        <div class="text-center mt-4">
                            <div class="mb-3">
                                <a href="index.html" class="auth-logo">
                                    <img src="/logo/logo.png" height="30" class="logo-dark mx-auto" alt="">
                                    <img src="/logo/logo2_footer.png" height="30" class="logo-light mx-auto" alt="">
                                </a>
                            </div>
                        </div>    
                        ...
                        <div class="p-3">
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" type="text" name="name" id="name" :value="old('name')" required placeholder="Name" autocomplete="off">
                                    </div>
                                </div> 

                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" type="text" name="username" id="username" :value="old('username')" required placeholder="Username" autocomplete="off">
                                    </div>
                                </div>   

                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" type="email" name="email" id="email" :value="old('email')" required placeholder="Email" autocomplete="off">
                                    </div>
                                </div>   
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" type="password" name="password_confirmation" required placeholder="Password confirmation" autocomplete="off">
                                    </div>
                                </div> 
